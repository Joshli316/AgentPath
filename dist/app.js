"use strict";(()=>{var Dt=Object.defineProperty;var w=(t,e)=>()=>(t&&(e=t(t=0)),e);var L=(t,e)=>{for(var s in e)Dt(t,s,{get:e[s],enumerable:!0})};function p(){try{let t=localStorage.getItem(tt);if(t)return{...I,...JSON.parse(t)}}catch{}return{...I}}function H(t){localStorage.setItem(tt,JSON.stringify(t))}function F(t,e){t.xp+=e;for(let s=G.length-1;s>=0;s--)if(t.xp>=G[s].xp){t.level=G[s].level;break}return H(t),t}function q(t){let e=new Date().toISOString().split("T")[0];if(t.lastActiveDate===e)return t;let s=new Date(Date.now()-864e5).toISOString().split("T")[0];return t.lastActiveDate===s?t.streak+=1:t.lastActiveDate!==e&&(t.streak=1),t.lastActiveDate=e,H(t),t}function et(t,e){return t.lessons[e]||(t.lessons[e]=!0,F(t,50),q(t)),t}function st(t,e){return t.milestones[e]||(t.milestones[e]=!0,F(t,100),q(t)),t}function nt(t,e){if(!t.projects[e]){t.projects[e]=!0,F(t,300);let s={s1:"first-agent",s2:"orchestrator",s3:"rag-master",s4:"protocol-builder",s5:"commander",s6:"graduate"};s[e]&&!t.badges.includes(s[e])&&t.badges.push(s[e]),q(t)}return t}function D(t,e,s){let a=Math.min(50,Math.max(10,Math.round(s/2))),r=t.games[e]||{bestScore:0,plays:0};if(t.games[e]={bestScore:Math.max(r.bestScore,s),plays:r.plays+1},s===100){let o={"s1-concept-quiz":"api-master","s2-concept-quiz":"framework-king","s3-concept-quiz":"vector-hero","s4-concept-quiz":"mcp-pro","s5-concept-quiz":"monitor-king","s6-concept-quiz":"interview-pro"};o[e]&&!t.badges.includes(o[e])&&t.badges.push(o[e])}return F(t,a),q(t),t}function X(t,e,s){return t.bonusProjects[e]=s,s==="complete"?(F(t,200),q(t)):H(t),t}function O(t){let e=G.find(r=>r.level===t.level),s=G.find(r=>r.level===t.level+1),a=s?(t.xp-e.xp)/(s.xp-e.xp)*100:100;return{current:e,next:s,progress:a}}var tt,I,G,S=w(()=>{"use strict";tt="agentpath",I={currentSprint:1,currentDay:1,xp:0,level:1,streak:0,lastActiveDate:"",lessons:{},milestones:{},projects:{},games:{},badges:[],skills:{python:0,"llm-apis":0,"agent-frameworks":0,rag:0,mcp:0,"multi-agent":0},lang:"en",bonusProjects:{}},G=[{level:1,title:"\u65B0\u624B Novice",titleEn:"Novice",xp:0},{level:2,title:"\u5B66\u5F92 Apprentice",titleEn:"Apprentice",xp:1e3},{level:3,title:"\u6784\u5EFA\u8005 Builder",titleEn:"Builder",xp:3e3},{level:4,title:"\u5DE5\u5320 Craftsman",titleEn:"Craftsman",xp:6e3},{level:5,title:"\u67B6\u6784\u5E08 Architect",titleEn:"Architect",xp:1e4},{level:6,title:"\u667A\u8005 Agent Master",titleEn:"Agent Master",xp:15e3}]});function at(){N=p().lang,document.documentElement.lang=N}function n(t,e){let s=Zt[t];if(!s)return t;let a=s[N]||s.en||t;if(e)for(let[r,o]of Object.entries(e))a=a.replace(`{${r}}`,String(o));return a}function b(){return N}function Gt(t){N=t,document.documentElement.lang=t;let e=p();e.lang=t,H(e)}function rt(){Gt(N==="en"?"zh":"en")}var Zt,N,k=w(()=>{"use strict";S();Zt={"nav.dashboard":{en:"Dashboard",zh:"\u4EEA\u8868\u76D8"},"nav.sprint":{en:"Sprint",zh:"\u51B2\u523A"},"nav.games":{en:"Games",zh:"\u6E38\u620F"},"nav.roadmap":{en:"Roadmap",zh:"\u8DEF\u7EBF\u56FE"},"nav.profile":{en:"Profile",zh:"\u4E2A\u4EBA"},"dash.today":{en:"Today",zh:"\u4ECA\u5929"},"dash.current-sprint":{en:"Current Sprint",zh:"\u5F53\u524D\u51B2\u523A"},"dash.day-of":{en:"Day {n} of 10",zh:"\u7B2C{n}\u5929 / \u517110\u5929"},"dash.xp":{en:"XP",zh:"\u7ECF\u9A8C\u503C"},"dash.streak":{en:"day streak",zh:"\u5929\u8FDE\u7EED"},"dash.level":{en:"Level",zh:"\u7B49\u7EA7"},"sprint.objectives":{en:"Sprint Objectives",zh:"\u51B2\u523A\u76EE\u6807"},"sprint.lesson":{en:"Lesson",zh:"\u8BFE\u7A0B"},"sprint.project":{en:"Project",zh:"\u9879\u76EE"},"sprint.review":{en:"Review & Games",zh:"\u590D\u4E60\u4E0E\u6E38\u620F"},"lesson.complete":{en:"Mark Complete",zh:"\u6807\u8BB0\u5B8C\u6210"},"lesson.completed":{en:"Completed",zh:"\u5DF2\u5B8C\u6210"},"lesson.try-it":{en:"Try it in iTerm",zh:"\u5728iTerm\u4E2D\u8BD5\u8BD5"},"lesson.key-terms":{en:"Key Terms",zh:"\u5173\u952E\u672F\u8BED"},"lesson.min":{en:"min",zh:"\u5206\u949F"},"project.milestones":{en:"Milestones",zh:"\u91CC\u7A0B\u7891"},"project.stuck":{en:"Stuck? Get a hint",zh:"\u5361\u4F4F\u4E86\uFF1F\u83B7\u53D6\u63D0\u793A"},"project.hint":{en:"Hint",zh:"\u63D0\u793A"},"project.stretch":{en:"Stretch Goals",zh:"\u989D\u5916\u76EE\u6807"},"project.complete":{en:"Project Complete!",zh:"\u9879\u76EE\u5B8C\u6210\uFF01"},"project.mark-complete":{en:"Mark Project Complete",zh:"\u6807\u8BB0\u9879\u76EE\u5B8C\u6210"},"games.select":{en:"Choose a Game",zh:"\u9009\u62E9\u6E38\u620F"},"games.flash-match":{en:"Flash Match",zh:"\u95EA\u914D"},"games.concept-quiz":{en:"Concept Quiz",zh:"\u6982\u5FF5\u6D4B\u9A8C"},"games.prompt-builder":{en:"Prompt Builder",zh:"\u63D0\u793A\u6784\u5EFA"},"games.score":{en:"Score",zh:"\u5F97\u5206"},"games.best":{en:"Best",zh:"\u6700\u4F73"},"games.play-again":{en:"Play Again",zh:"\u518D\u73A9\u4E00\u6B21"},"games.back":{en:"Back to Games",zh:"\u8FD4\u56DE\u6E38\u620F"},"roadmap.title":{en:"Your 12-Week Journey",zh:"\u4F60\u768412\u5468\u65C5\u7A0B"},"roadmap.locked":{en:"Locked",zh:"\u672A\u89E3\u9501"},"roadmap.active":{en:"Active",zh:"\u8FDB\u884C\u4E2D"},"roadmap.complete":{en:"Complete",zh:"\u5DF2\u5B8C\u6210"},"profile.skills":{en:"Skills Radar",zh:"\u6280\u80FD\u96F7\u8FBE"},"profile.badges":{en:"Badges",zh:"\u5FBD\u7AE0"},"profile.stats":{en:"Stats",zh:"\u7EDF\u8BA1"},"profile.export":{en:"Export for Resume",zh:"\u5BFC\u51FA\u7B80\u5386"},"profile.total-xp":{en:"Total XP",zh:"\u603B\u7ECF\u9A8C\u503C"},"profile.projects-done":{en:"Projects Done",zh:"\u5B8C\u6210\u9879\u76EE"},"profile.days-active":{en:"Days Active",zh:"\u6D3B\u8DC3\u5929\u6570"},"profile.longest-streak":{en:"Longest Streak",zh:"\u6700\u957F\u8FDE\u7EED"},"profile.next-steps":{en:"Next Steps \u2014 Keep Growing",zh:"\u4E0B\u4E00\u6B65\u2014\u2014\u7EE7\u7EED\u6210\u957F"},"games.match-instruction":{en:"Tap a term, then tap its matching definition.",zh:"\u70B9\u51FB\u672F\u8BED\uFF0C\u7136\u540E\u70B9\u51FB\u5339\u914D\u7684\u5B9A\u4E49\u3002"},"games.correct":{en:"Correct!",zh:"\u6B63\u786E\uFF01"},"games.wrong-answer":{en:"Wrong \u2014 the answer is",zh:"\u9519\u8BEF\u2014\u2014\u7B54\u6848\u662F"},"games.next":{en:"Next",zh:"\u4E0B\u4E00\u9898"},"games.complete":{en:"Complete!",zh:"\u5B8C\u6210\uFF01"},"games.time":{en:"Time",zh:"\u7528\u65F6"},"games.attempts":{en:"Attempts",zh:"\u5C1D\u8BD5\u6B21\u6570"},"games.correct-count":{en:"correct",zh:"\u6B63\u786E"},"games.match-desc":{en:"Match terms to definitions",zh:"\u5C06\u672F\u8BED\u4E0E\u5B9A\u4E49\u5339\u914D"},"games.quiz-desc":{en:"Test your knowledge",zh:"\u6D4B\u8BD5\u4F60\u7684\u77E5\u8BC6"},"games.builder-desc":{en:"Assemble API calls",zh:"\u7EC4\u88C5API\u8C03\u7528"},"games.check":{en:"Check",zh:"\u68C0\u67E5"},"games.not-quite":{en:"Not quite \u2014 try rearranging the parts.",zh:"\u4E0D\u592A\u5BF9\u2014\u2014\u8BD5\u8BD5\u91CD\u65B0\u6392\u5217\u3002"},"games.expected":{en:"Expected:",zh:"\u9884\u671F\uFF1A"},"games.available-parts":{en:"Available parts:",zh:"\u53EF\u7528\u90E8\u5206\uFF1A"},"games.tap-to-build":{en:"Tap code parts below to build the call...",zh:"\u70B9\u51FB\u4E0B\u65B9\u4EE3\u7801\u7247\u6BB5\u6765\u6784\u5EFA\u8C03\u7528..."},"roadmap.weeks":{en:"Weeks",zh:"\u5468"},"roadmap.bonus-title":{en:"Bonus Projects",zh:"\u989D\u5916\u9879\u76EE"},"roadmap.start":{en:"Start",zh:"\u5F00\u59CB"},"roadmap.mark-complete":{en:"Complete",zh:"\u5B8C\u6210"},"roadmap.done":{en:"Done",zh:"\u5DF2\u5B8C\u6210"},"roadmap.view-sprint":{en:"View Sprint",zh:"\u67E5\u770B\u51B2\u523A"},"dash.xp-to-next":{en:"XP to next",zh:"\u7ECF\u9A8C\u503C\u5230\u4E0B\u4E00\u7EA7"},"sprint.current":{en:"current",zh:"\u5F53\u524D"}},N="en"});async function E(t){let s=`content/${b()}/${t}`;if(P.has(s))return P.get(s);let a=await fetch(s);if(!a.ok){let o=`content/en/${t}`;if(P.has(o))return P.get(o);let i=await fetch(o);if(!i.ok)throw new Error(`Content not found: ${t}`);let c=await i.json();return P.set(o,c),c}let r=await a.json();return P.set(s,r),r}async function M(t){let e=`content/shared/${t}`;if(P.has(e))return P.get(e);let s=await fetch(e);if(!s.ok)throw new Error(`Shared content not found: ${t}`);let a=await s.json();return P.set(e,a),a}function ot(){P.clear()}var P,j=w(()=>{"use strict";k();P=new Map});function Ot(t,e=20){let s=Math.round(t/100*e),a=e-s;return'<span class="text-ap-green">'+"\u2593".repeat(s)+'</span><span class="text-ap-text-muted">'+"\u2591".repeat(a)+"</span>"}function J(t,e){return`
  ...
  `}var ct=w(()=>{"use strict"});function l(t){return t.replace(/[&<>"']/g,e=>Qt[e])}function u(t,e){let s=b(),a=`${e}Zh`;return s==="zh"&&a in t?String(t[a]):String(t[e]??"")}function Z(t){return`
    ...
    </div>`}var Qt,_=w(()=>{"use strict";k();Qt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}});var dt={};L(dt,{renderDashboard:()=>Xt});async function Xt(){let t=p(),s=(await M("sprints.json"))[t.currentSprint-1],a=b(),r=O(t),o=u(s,"title"),i=u(s,"project"),c=a==="zh"?r.current.title.split(" ")[0]:r.current.titleEn,d=s.days.filter(g=>g.type==="lesson").length,x=s.days.filter(g=>g.type==="lesson").filter(g=>t.lessons[`s${s.id}-${g.ref}`]).length,m=t.projects[`s${s.id}`]||!1,f=Math.round((x+(m?1:0))/(d+1)*100),h=s.days[t.currentDay-1],y="",v="",$="";if(h)if(h.type==="lesson"){let g=h.ref.replace("lesson-","");y=`${n("sprint.lesson")} ${g}`,v="~20 "+n("lesson.min"),$=`#/sprint/${s.id}/lesson/${g}`}else h.type==="project"?(y=i,v="~60 "+n("lesson.min"),$=`#/sprint/${s.id}/project`):(y=n("sprint.review"),v="~30 "+n("lesson.min"),$=`#/sprint/${s.id}/games`);return`
    <!-- Status bar -->
  ...
  `}var pt=w(()=>{"use strict";S();k();j();ct();_()});var mt={};L(mt,{renderSprint:()=>Kt});async function Kt(t){let e=p(),a=(await M("sprints.json"))[t-1];if(!a)return'<div class="text-ap-red">Sprint not found</div>';let r=u(a,"title"),o=u(a,"project"),i=a.days.map(c=>{let d="\u{1F4D6}",x=n("sprint.lesson"),m=`#/sprint/${t}/lesson/${c.ref.replace("lesson-","")}`,f=!1;c.type==="lesson"?f=!!e.lessons[`s${t}-${c.ref}`]:c.type==="project"?(d="\u{1F528}",x=n("sprint.project"),m=`#/sprint/${t}/project`,f=!!e.projects[`s${t}`]):(d="\u25C6",x=n("sprint.review"),m=`#/sprint/${t}/games`);let h=c.day===e.currentDay&&t===e.currentSprint,y=t>e.currentSprint;return`
        <a href="${y?"#":m}"
  ...
  `}var gt=w(()=>{"use strict";S();k();j();_()});var xt={};L(xt,{renderLesson:()=>Wt});function Jt(t){let e=b();switch(t.type){case"text":return`<div class="text-ap-text text-sm leading-relaxed mb-4">${l(t.content||"")}</div>`;case"code":return`
      ...
      `;default:return""}}async function Wt(t,e){let s=p(),a=await E(`sprint-${t}/lesson-${e.padStart(2,"0")}.json`),r=b(),o=u(a,"title"),i=`s${t}-lesson-${e.padStart(2,"0")}`,c=!!s.lessons[i],d=a.steps.map(Jt).join("");return`
    ...
    <h1 class="text-ap-text text-xl font-bold mb-6">${o}</h1>

    ${d}

    <div class="mt-8 mb-4">
      ${c?`<div class="text-ap-green text-sm font-bold">\u2713 ${n("lesson.completed")} (+50 XP)</div>`:`<button onclick="window.__completeLesson('${i}', ${t})"
               class="w-full bg-ap-green text-ap-bg font-bold py-3 rounded text-sm hover:opacity-90 transition-opacity">
               ${n("lesson.complete")}
             </button>`}
    </div>
  `}var ut=w(()=>{"use strict";S();k();j();_();window.__completeLesson=(t,e)=>{let s=p();if(et(s,t),e===s.currentSprint){let a=Object.keys(s.lessons).filter(r=>r.startsWith(`s${e}-`)).length;s.currentDay=Math.min(a+1,10),H(s)}window.dispatchEvent(new HashChangeEvent("hashchange"))}});var ht={};L(ht,{renderProject:()=>Ut});async function Ut(t){let e=p(),s=await E(`sprint-${t}/project.json`),a=b(),r=u(s,"title"),o=u(s,"description"),i=`s${t}`,c=!!e.projects[i],d=s.milestones.every(h=>!!e.milestones[`${i}-${h.id}`]),x=s.milestones.map(h=>{let y=`${i}-${h.id}`,v=!!e.milestones[y],$=u(h,"label"),g=s.hints[h.id]||[];return`
        <div class="terminal-card p-3 mb-2">
          <div class="flex items-center gap-3">
            ...
            <span class="text-sm ${v?"text-ap-text-dim line-through":"text-ap-text"}">${l($)}</span>
          </div>
          ${!v&&g.length>0?`<details class="mt-2 ml-8">
                  <summary class="text-ap-amber text-xs cursor-pointer hover:underline">${n("project.stuck")}</summary>
                  <div class="mt-2 flex flex-col gap-1">
                    ${g.map((z,T)=>`<div class="text-ap-text-dim text-xs">\u{1F4A1} ${n("project.hint")} ${T+1}: ${l(z)}</div>`).join("")}
                  </div>
                </details>`:""}
        </div>
  ...
  `}var yt=w(()=>{"use strict";S();k();j();_();window.__selectTerm=t=>{let e=window.__flashMatchState;e.matched.has(t)||(document.querySelectorAll("[id^='term-']").forEach(s=>s.classList.remove("ring-1","ring-ap-green")),document.getElementById(`term-${t}`)?.classList.add("ring-1","ring-ap-green"),e.selectedTerm=t)};window.__selectDef=t=>{let e=window.__flashMatchState;if(e.selectedTerm===null||e.matched.has(t))return;e.attempts++;let s=document.getElementById(`term-${e.selectedTerm}`),a=document.getElementById(`def-${t}`);if(e.selectedTerm===t){if(e.matched.add(t),s?.classList.add("opacity-30"),a?.classList.add("opacity-30"),s?.classList.remove("ring-1","ring-ap-green"),e.selectedTerm=null,e.matched.size===e.total){let r=Math.round((Date.now()-e.startTime)/1e3),o=Math.round(e.total/e.attempts*100),i=Math.min(100,o),c=p();D(c,`s${e.sprintId}-flash-match`,i);let d=document.getElementById("flash-match-result");d&&(d.classList.remove("hidden"),d.innerHTML=`
        ...
        `)}}else a?.classList.add("border-ap-red"),setTimeout(()=>a?.classList.remove("border-ap-red"),500),s?.classList.remove("ring-1","ring-ap-green"),e.selectedTerm=null}});var kt={};L(kt,{renderConceptQuiz:()=>It});async function It(t){let e=await E(`sprint-${t}/games.json`),s=b(),a=e["concept-quiz"].questions;return window.__quizState={sprintId:t,questions:a,current:0,correct:0,answered:!1},wt(0,a,s,t)}function wt(t,e,s,a){let r=e[t],o=s==="zh"?r.qZh:r.q,i=r.options.map((c,d)=>`
  ...
  `}var St=w(()=>{"use strict";S();k();j();_();window.__answerQuiz=t=>{let e=window.__quizState;if(e.answered)return;e.answered=!0;let s=e.questions[e.current],a=t===s.answer;a&&e.correct++;let r=document.getElementById(`opt-${t}`),o=document.getElementById(`opt-${s.answer}`);a?r?.classList.add("border-ap-green","bg-ap-green-dim"):(r?.classList.add("border-ap-red","bg-ap-red-dim"),o?.classList.add("border-ap-green","bg-ap-green-dim"));for(let d=0;d<s.options.length;d++)document.getElementById(`opt-${d}`)?.classList.add("pointer-events-none");let i=document.getElementById("quiz-feedback");i&&(i.innerHTML=a?`<div class="text-ap-green text-sm">\u2713 ${n("games.correct")}</div>`:`<div class="text-ap-red text-sm">\u2717 ${n("games.wrong-answer")} ${String.fromCharCode(65+s.answer)}</div>`);let c=document.getElementById("quiz-next");if(c)if(c.classList.remove("hidden"),e.current<e.questions.length-1)c.innerHTML=`
      ...
      `;else{let d=Math.round(e.correct/e.questions.length*100),x=p();D(x,`s${e.sprintId}-concept-quiz`,d),c.innerHTML=`
        <div class="terminal-card p-4 text-center">
      ...
      `}};window.__nextQuestion=()=>{let t=window.__quizState;t.current++,t.answered=!1;let e=b(),s=document.querySelector("main");s&&(s.innerHTML=wt(t.current,t.questions,e,t.sprintId))}});var Lt={};L(Lt,{renderPromptBuilder:()=>te});async function te(t){let e=await E(`sprint-${t}/games.json`),s=b(),a=e["prompt-builder"].challenges,r=a[0];return window.__pbState={sprintId:t,challenges:a,currentChallenge:0,placed:[],available:[...r.parts].sort(()=>Math.random()-.5)},ee(r,s,t)}function ee(t,e,s){let a=window.__pbState,r=e==="zh"?t.instructionZh:t.instruction;return`
    ...
    <p class="text-ap-text text-sm mb-6">${l(r)}</p>
    ...
    <div class="terminal-card mb-4">
      ...
      <div id="pb-placed" class="p-3 min-h-[80px]">${zt(a)}</div>
    </div>

    <div class="text-ap-text-muted text-xs mb-2">${n("games.available-parts")}</div>
    <div id="pb-available" class="mb-4">${jt(a)}</div>
...
`)}</div>
      ...
      `}).join(""),a="";try{let r=await M("bonus-projects.json"),o={easy:"text-ap-green bg-ap-green-dim",medium:"text-ap-amber bg-ap-amber-dim",hard:"text-ap-red bg-ap-red-dim"};a=r.map(i=>{let c=u(i,"title"),d=u(i,"description"),x=t.bonusProjects[i.id];return`
        <div class="terminal-card p-3">
          ...
          <div class="flex items-center justify-between">
            ...
            ${x?x==="in-progress"?`<button onclick="window.__completeBonus('${l(i.id)}')" class="text-ap-amber text-xs border border-ap-amber rounded px-2 py-1 hover:bg-ap-amber-dim">${n("roadmap.mark-complete")}</button>`:`<span class="text-ap-green text-xs">\u2713 ${n("roadmap.done")} (+200 XP)</span>`:`<button onclick="window.__startBonus('${l(i.id)}')" class="text-ap-green text-xs border border-ap-green rounded px-2 py-1 hover:bg-ap-green-dim">${n("roadmap.start")}</button>`}
          </div>
        </div>
      `}).join("")}catch{}return`
    ...
    `:""}
  `}var Mt=w(()=>{"use strict";S();k();j();_();window.__startBonus=t=>{let e=p();X(e,t,"in-progress"),window.dispatchEvent(new HashChangeEvent("hashchange"))};window.__completeBonus=t=>{let e=p();X(e,t,"complete"),window.dispatchEvent(new HashChangeEvent("hashchange"))}});function Ct(t,e=5){let s=[{key:"python",label:"Python"},{key:"llm-apis",label:"LLM APIs"},{key:"agent-frameworks",label:"Agents"},{key:"rag",label:"RAG"},{key:"mcp",label:"MCP"},{key:"multi-agent",label:"Multi-Agent"}],a=150,r=150,o=100,i=s.length;function c(v,$){let g=(v-90)*(Math.PI/180);return[a+$*Math.cos(g),r+$*Math.sin(g)]}let x=[.2,.4,.6,.8,1].map(v=>`<polygon points="${s.map((g,z)=>{let T=360/i*z;return c(T,o*v).join(",")}).join(" ")}" fill="none" stroke="#334155" stroke-width="0.5"/>`).join(""),m=s.map((v,$)=>{let g=360/i*$,[z,T]=c(g,o);return`<line x1="${a}" y1="${r}" x2="${z}" y2="${T}" stroke="#334155" stroke-width="0.5"/>`}).join(""),f=s.map((v,$)=>{let g=(t[v.key]||0)/e,z=360/i*$;return c(z,o*g).join(",")}).join(" "),h=s.map((v,$)=>{let g=360/i*$,[z,T]=c(g,o+20),Q=z<a-10?"end":z>a+10?"start":"middle",Rt=t[v.key]||0;return`<text x="${z}" y="${T}" text-anchor="${Q}" fill="#94a3b8" font-size="10" font-family="monospace">${v.label} (${Rt})</text>`}).join(""),y=s.map((v,$)=>{let g=(t[v.key]||0)/e,z=360/i*$,[T,Q]=c(z,o*g);return`<circle cx="${T}" cy="${Q}" r="3" fill="#00ff88"/>`}).join("");return`
  ...
  `}var Tt=w(()=>{"use strict"});function At(t,e){let s=u(t,"name"),a=u(t,"desc"),r=t.type==="project"?"\u{1F3C6}":"\u2B50";return`
  ...
  `}var Ht=w(()=>{"use strict";_()});var qt={};L(qt,{renderProfile:()=>ne});async function ne(){let t=p(),e=await M("badges.json"),s=b(),a=O(t),r=s==="zh"?a.current.title.split(" ")[0]:a.current.titleEn,o=e.map(x=>At(x,t.badges.includes(x.id))).join(""),i=Object.values(t.projects).filter(Boolean).length,c=Object.keys(t.lessons).length+Object.keys(t.milestones).length,d="";try{let x=await M("next-steps.json"),m={Certification:"text-ap-green bg-ap-green-dim",Community:"text-ap-indigo bg-ap-indigo-dim",Portfolio:"text-ap-amber bg-ap-amber-dim","Personal Brand":"text-ap-amber bg-ap-amber-dim",Networking:"text-ap-indigo bg-ap-indigo-dim","Skill Depth":"text-ap-green bg-ap-green-dim","Emerging Tech":"text-ap-red bg-ap-red-dim",Research:"text-ap-indigo bg-ap-indigo-dim",Career:"text-ap-amber bg-ap-amber-dim",Mastery:"text-ap-green bg-ap-green-dim","Deep Understanding":"text-ap-red bg-ap-red-dim"};d=x.map((f,h)=>{let y=u(f,"title"),v=u(f,"description"),$=u(f,"category"),g=m[f.category]||"text-ap-text-muted bg-ap-surface";return`
        <div class="terminal-card p-3">
          <div class="flex items-center gap-2 mb-1">
          ...
          <div class="flex items-center gap-2 mb-2">
            <span class="${g} text-xs px-1.5 py-0.5 rounded">${l($)}</span>
...
Skills: Python ${t.skills.python}/5, LLM APIs ${t.skills["llm-apis"]}/5, Agent Frameworks ${t.skills["agent-frameworks"]}/5, RAG ${t.skills.rag}/5, MCP ${t.skills.mcp}/5, Multi-Agent ${t.skills["multi-agent"]}/5`;navigator.clipboard.writeText(s).then(()=>{alert("Copied to clipboard!")})}});var V=[];function A(t,e){let s=[],a=new RegExp("^"+t.replace(/:(\w+)/g,(r,o)=>(s.push(o),"([^/]+)")).replace(/\//g,"\\/")+"$");V.push({pattern:a,keys:s,handler:e})}function Nt(t){window.location.hash=t}function Y(){let t=()=>{let e=window.location.hash.slice(1)||"/";for(let s of V){let a=e.match(s.pattern);if(a){let r={};s.keys.forEach((o,i)=>{r[o]=a[i+1]}),s.handler(r);return}}Nt("/")};window.addEventListener("hashchange",t),t()}S();k();j();k();S();var K=[{id:"dashboard",path:"/",icon:"\u2302",key:"nav.dashboard"},{id:"sprint",path:"/sprint/1",icon:"\u25B6",key:"nav.sprint"},{id:"games",path:"/sprint/1/games",icon:"\u25C6",key:"nav.games"},{id:"roadmap",path:"/roadmap",icon:"\u25C7",key:"nav.roadmap"},{id:"profile",path:"/profile",icon:"\u25CB",key:"nav.profile"}];function Ft(){let t=window.location.hash.slice(1)||"/";return t==="/"?"dashboard":t.includes("/games")?"games":t.includes("/sprint")?"sprint":t.includes("/roadmap")?"roadmap":t.includes("/profile")?"profile":"dashboard"}function it(){let t=p(),e=Ft(),s=t.currentSprint;return K[1].path=`/sprint/${s}`,K[2].path=`/sprint/${s}/games`,`
  ...
  `}function lt(){return"pb-20 md:pb-0 md:pl-48"}var W=document.getElementById("app");function U(t){return`
    ...
    ${it()}
  `}function C(t){W.innerHTML=U(t)}function B(){W.innerHTML=U(`
    <div class="flex items-center justify-center py-20">
      <div class="text-ap-green text-sm glow-green">Loading...</div>
    </div>
  `)}function R(t){W.innerHTML=U(`
  ...
  `)}window.__toggleLang=()=>{rt(),ot(),window.dispatchEvent(new HashChangeEvent("hashchange"))};at();var ae=p();q(ae);A("/",async()=>{B();try{let{renderDashboard:t}=await Promise.resolve().then(()=>(pt(),dt));C(await t())}catch{R("Failed to load dashboard")}});A("/sprint/:id",async t=>{B();try{let{renderSprint:e}=await Promise.resolve().then(()=>(gt(),mt));C(await e(Number(t.id)))}catch{R("Failed to load sprint")}});A("/sprint/:id/lesson/:num",async t=>{B();try{let{renderLesson:e}=await Promise.resolve().then(()=>(ut(),xt));C(await e(Number(t.id),t.num))}catch{R("Failed to load lesson")}});A("/sprint/:id/project",async t=>{B();try{let{renderProject:e}=await Promise.resolve().then(()=>(vt(),ht));C(await e(Number(t.id)))}catch{R("Failed to load project")}});A("/sprint/:id/games",t=>{Promise.resolve().then(()=>(bt(),ft)).then(({renderGames:e})=>{C(e(Number(t.id)))})});A("/sprint/:id/games/:game",async t=>{B();try{let e=Number(t.id),s=t.game;if(s==="flash-match"){let{renderFlashMatch:a}=await Promise.resolve().then(()=>(yt(),$t));C(await a(e))}else if(s==="concept-quiz"){let{renderConceptQuiz:a}=await Promise.resolve().then(()=>(St(),kt));C(await a(e))}else if(s==="prompt-builder"){let{renderPromptBuilder:a}=await Promise.resolve().then(()=>(Pt(),Lt));C(await a(e))}}catch{R("Failed to load game")}});A("/roadmap",async()=>{B();try{let{renderRoadmap:t}=await Promise.resolve().then(()=>(Mt(),Et));C(await t())}catch{R("Failed to load roadmap")}});A("/profile",async()=>{B();try{let{renderProfile:t}=await Promise.resolve().then(()=>(Bt(),qt));C(await t())}catch{R("Failed to load profile")}});Y();})();
